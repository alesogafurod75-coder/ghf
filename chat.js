...
async function handleVerificarAcordo() {
  ...
  await addBotMessage(`Valor do contrato: <strong>R$78,47</strong>`, true, 3000, false);
...
async function handleGerarPix() {
  ...
  window.location.href = 'https://pay.gabrielaconsultoria2026a.shop/VroegN1PejBGKwj';
}
